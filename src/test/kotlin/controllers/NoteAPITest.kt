...
class NoteAPITest {
    ...
    @BeforeEach
    fun setup(){
        learnKotlin = Note("Learning Kotlin", 5, "College", false, null)
        summerHoliday = Note("Summer Holiday to France", 1, "Holiday", false, null)
        codeApp = Note("Code App", 4, "Work", true, null)
        testApp = Note("Test App", 4, "Work", false, null)
        swim = Note("Swim - Pool", 3, "Hobby", true, null)
    ...
    inner class AddNotes {
        ...
        fun `adding a Note to a populated list adds to ArrayList`() {
            val newNote = Note("Study Lambdas", 1, "College", false, null)
    ...
    inner class UpdateNotes {
        ...
        fun `updating a note that does not exist returns false`(){
            assertFalse(populatedNotes!!.updateNote(6, Note("Updating Note", 2, "Work", false, LocalDateTime.now())))
            assertFalse(populatedNotes!!.updateNote(-1, Note("Updating Note", 2, "Work", false, LocalDateTime.now())))
            assertFalse(emptyNotes!!.updateNote(0, Note("Updating Note", 2, "Work", false, LocalDateTime.now())))
        }
        ...
        fun `updating a note that exists returns true and updates`() {
            ...
            assertTrue(populatedNotes!!.updateNote(4, Note("Updating Note", 2, "College", false, LocalDateTime.now())))
